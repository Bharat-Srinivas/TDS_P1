...
API_KEY = "eyJhbGciOiJIUzI1NiJ9.eyJlbWFpbCI6IjIzZjMwMDQzODFAZHMuc3R1ZHkuaWl0bS5hYy5pbiJ9.GUGxaoU6-S2aLV1c6NeB-35ZqlnvVRUh2oC3XzKtIxg" # Get API key from environment variable
...
async def root_post():
    return {
        "answer": "Please use the /api/ endpoint.",
        "links": [
            {
                "url": "https://tds.s-anand.net/#/project1",
                "text": "Project 1 Instructions"
            }
        ]
    }
